...
<head>
    ...
    <p>
    <strong>Cake Pusher</strong> will periodically scan its own <a href="http://identi.ca/<?php echo $GLOBALS['CONFIG']['STATUSNET_TIMELINE']; ?>/">Home Timeline</a> for the keywords:
    </p>
    ...
    <p>
    If it can be determined that two people have talked about cakes within <?php  echo floor($GLOBALS['CONFIG']['MAX_TIMELAPSE']/60); ?> minutes
    and <?php echo $GLOBALS['CONFIG']['MAX_DISTANCE']; ?>km of each other, Cake Pusher will dent:
    </p>
    ...
    Code available at <a href="https://github.com/connerbw/cakepusher">GitHub</a>.
    </p>
